...
public interface PrivilegeResourceRepository extends Repository {
	...
	void deleteByResourceId(@Param("resourceIds")String[] resourceIds,@Param("appId")String appId);
	...
	PrivilegeResource getResourceListByFunId(@Param("functionId")String functionId,@Param("appId")String appId);
}
