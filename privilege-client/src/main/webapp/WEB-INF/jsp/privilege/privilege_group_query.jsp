...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="getGroupPrivilege" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeGroupQueryUrl" id="privilegeGroupQueryUrl" value="${privilegeGroupQueryUrl}"/>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用组织机构权限查询接口</button>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var limit=$("#limit").val();
	    var start=$("#start").val();
	    var privilegeGroupQueryUrl=$("#privilegeGroupQueryUrl").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeGroupQueryUrl+"?"+"appId="+appId+"&limit="+limit+"&groupId="+groupId+"&start="+start
