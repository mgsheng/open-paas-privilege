...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="delUserRoleRedisPrivilegeTest" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeUserRoleQueryTestUrl" id="privilegeUserRoleQueryTestUrl" value="${privilegeUserRoleUpdateTestUrl}"/>
                ...
                <div ng-show="visible">
                 <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">appUserId（必传）</p>
                        </div>
                    </div>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用用户角色缓存查询测试接口</button>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var privilegeUserRoleQueryTestUrl=$("#privilegeUserRoleQueryTestUrl").val();
		if(appId=='' || appUserId==''){
		    alert("请输入必传参数");
			return;
		}
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeUserRoleQueryTestUrl+"?"+"appId="+appId+"&appUserId="+appUserId
