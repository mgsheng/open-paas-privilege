...
<script type="text/javascript">
	function btnSubmit(){
		...
		$.post("${contextPath}/getSignature1",
			{
				appId:appId
			},
			function(data){
				if(data.flag){
					...
					var uri=addPrivilegeRoleUri+"?"+"appId="+appId+"&roleName="+roleName+"&rolePrivilege="+rolePrivilege+"&groupId="+groupId+"&groupName="+groupName
							+"&deptId="+deptId+"&deptName="+deptName+"&roleLevel="+roleLevel+"&remark="+remark+"&createUser="+createUser+"&createUserId="+createUserId+"&status="+status
