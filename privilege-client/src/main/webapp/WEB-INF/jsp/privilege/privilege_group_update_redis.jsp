...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="updateGroupPrivilegeRedis" method="post" class="form-horizontal">
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用组织机构缓存删除接口</button>
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeGroupQueryTestUrl+"?"+"appId="+appId+"&groupId="+groupId
