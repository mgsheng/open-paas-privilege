...
<html>
<head>
    <title>del-privilege-role(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="delPrivilegeRole" method="post" class="form-horizontal">
                <input type="hidden" name="delPrivilegeRoleUri" id="delPrivilegeRoleUri" value="${delPrivilegeRoleUri}"/>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用角色删除接口</button>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var delPrivilegeRoleUri=$("#delPrivilegeRoleUri").val();
		if(appId=='' || privilegeRoleId==''){
		    alert("请输入必传参数");
			return;
		}
