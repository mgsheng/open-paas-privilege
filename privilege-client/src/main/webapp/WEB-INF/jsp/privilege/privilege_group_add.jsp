...
<html>
<head>
    <title>privilege_group_add(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="addPrivilege" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeGroupAddUrl" id="privilegeGroupAddUrl" value="${privilegeGroupAddUrl}"/>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var privilegeGroupAddUrl=$("#privilegeGroupAddUrl").val();
		...
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeGroupAddUrl+"?"+"appId="+appId+"&groupPrivilege="+groupPrivilege+"&groupId="+groupId+"&groupName="+groupName
