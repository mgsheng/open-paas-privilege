...
<html>
<head>
    <title>privilege_resource_add(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="addResource" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeResourceAddUrl" id="privilegeResourceAddUrl" value="${privilegeResourceAddUrl}"/>
                ...
                <div ng-show="visible">
	                <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">资源级别（必传）（0：基础功能 1：服务级别，2:应用级别）</p>
                        </div>
                    </div>
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary" id="addPrivilegeResource"></div> 
                    </div>
                </div>
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用权限资源添加接口</button>
...
<script type="text/javascript">
	function btnSubmit(){
		...
		if(appId=='' || resourceLevel==''|| resourceName==''|| menuId==''){
		    alert("请输入必传参数");
			return;
		}
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeResourceAddUrl+"?"+"appId="+appId+"&resourceLevel="+resourceLevel+"&resourceName="+resourceName+"&menuId="+menuId
					...
					$("#addPrivilegeResource").html(uri);
				}else{
				    jQuery("#addPrivilegeResource").html('无效数据，请重新申请');
				}
			}
 		); 
	}
