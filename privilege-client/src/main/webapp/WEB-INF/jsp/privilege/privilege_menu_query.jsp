...
<html>
<head>
    <title>privilege_menu_query(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="getMenus" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeMenuQueryUrl" id="privilegeMenuQueryUrl" value="${privilegeMenuQueryUrl}"/>
                ...
                <div ng-show="visible">
                 <div class="form-group">
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary" id="queryPrivilegeMenu"></div> 
                    </div>
                </div>
                <br/>
                <br/>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var limit=$("#limit").val();
	    var start=$("#start").val();
	    var privilegeMenuQueryUrl=$("#privilegeMenuQueryUrl").val();
