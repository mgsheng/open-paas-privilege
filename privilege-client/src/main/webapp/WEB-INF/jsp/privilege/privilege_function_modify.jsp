...
<html>
<head>
    <title>privilege_function_modify(interface)</title>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="modifyFunction" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeFunctionModifyUrl" id="privilegeFunctionModifyUrl" value="${privilegeFunctionModifyUrl}"/>
                ...
                <div ng-show="visible">
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary" id="modifyPrivilegeFunction"></div> 
                    </div>
                </div>
                <br/>
                <br/>
...
<script type="text/javascript">
	function btnSubmit(){
	    ...
	    var privilegeFunctionModifyUrl=$("#privilegeFunctionModifyUrl").val();
		if(appId=='' || functionId==''){
		    alert("请输入必传参数");
			return;
		}
		$.post("${contextPath}/getSignature",
			...
			function(data){
				if(data.flag){
					...
					var uri=privilegeFunctionModifyUrl+"?"+"appId="+appId+"&functionId="+functionId+"&operationId="+operationId+"&optUrl="+optUrl
					...
					$("#modifyPrivilegeFunction").html(uri);
				}else{
				    jQuery("#modifyPrivilegeFunction").html('无效数据，请重新申请');
				}
			}
 		); 
	}
