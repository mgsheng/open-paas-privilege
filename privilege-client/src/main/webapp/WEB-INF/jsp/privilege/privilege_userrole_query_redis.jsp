...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="getUserRoleRedisPrivilegeTest" method="post" class="form-horizontal">
                <input type="hidden" name="privilegeUserRoleQueryTestUrl" id="privilegeUserRoleQueryTestUrl" value="${privilegeUserRoleQueryTestUrl}"/>
